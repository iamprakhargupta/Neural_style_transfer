...
content_image = scipy.misc.imread("images/220px-Sharbat_Gula.png")
content_image=scipy.misc.imresize(content_image,(300,225))
...
style_image = scipy.misc.imread("images/picasso_guernica_tapestry.png")
style_image=scipy.misc.imresize(style_image,(300,225))
imshow(style_image)
...
def compute_layer_style_cost(a_S, a_G):
    ...
    J_style_layer = tf.reduce_sum(tf.square(tf.subtract(GS,GG)))/(4*(n_C*n_H*n_W)*(n_C*n_H*n_W))
...
content_image = scipy.misc.imread("images/content12.jpg")
content_imag=scipy.misc.imresize(content_image,(300,400))
content_image = reshape_and_normalize_image(content_imag)
content_imag.shape
...
style_imag=scipy.misc.imresize(style_image,(300,400))
style_image = reshape_and_normalize_image(style_imag)
...
generated_image = generate_noise_image(content_imag)
